...
namespace CapaPresentacion
{
    public partial class frmVentas : Form
    {
        ...
        private void cmbImpresorasInstaladas_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            clsFunciones.CreaTicket Ticket1 = new clsFunciones.CreaTicket();
                ...
                Ticket1.TextoCentro("Empresa TECH GM "); //imprime una linea de descripcion
                Ticket1.TextoCentro("**********************************");
                ...
                Ticket1.AgregaTotales("Mas ITBIS", double.Parse("00")); // imprime linea con ITBis total
                Ticket1.TextoIzquierda(" ");
                Ticket1.AgregaTotales("Total", double.Parse("0")); // imprime linea con total
                Ticket1.TextoIzquierda(" ");
                Ticket1.AgregaTotales("Efectivo Entregado:", double.Parse("0"));
                Ticket1.AgregaTotales("Efectivo Devuelto:", double.Parse("0"));
