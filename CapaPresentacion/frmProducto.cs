...
namespace CapaPresentacion
{
    public partial class frmProducto : Form
    {
        ...
        private void btnCodigo_Click(object sender, EventArgs e)
        {
            ...
            pnBarras.BackgroundImage = Codigo.Encode(BarcodeLib.TYPE.CODE128, txtcodigo.Text, Color.Black, Color.White, 192, 82);
            btnGBarras.Visible = true;
            pnBarras.Visible = true;
        }

        private void btnGBarras_Click(object sender, EventArgs e)
        {
            Image imgFinal = (Image)pnBarras.BackgroundImage.Clone();
